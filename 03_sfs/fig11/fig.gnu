...
# plotting
plot 'Ppw_200.dat' binary matrix with image,\
...
# plotting
plot 'Ppw_500.dat' binary matrix with image,\
  'array.txt' @array_continuous
...
# plotting
plot 'Ppw_1000.dat' binary matrix with image,\
  'array.txt' @array_continuous
...
@pos_bottom_left
# plotting
plot 'Ppw_error_200.dat' binary matrix with image,\
  'array.txt' @array_continuous
...
# plotting
plot 'Ppw_error_500.dat' binary matrix with image,\
  'array.txt' @array_continuous
...
# plotting
plot 'Ppw_error_1000.dat' binary matrix with image,\
  'array.txt' @array_continuous
