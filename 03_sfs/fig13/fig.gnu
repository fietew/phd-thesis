...
# labels
load 'labels.cfg'
set label 1 at graph 0.55, 1.075 center front
...
set cbrange [-1:1]
set cbtics 1 offset -0.25,0
# labels
set label 1 '$M = 7$, rect.'
set label 2 at graph 0.5, 1.25 '$\sff = 500$ Hz'
# arrows
set arrow 1 from graph 0.0, 1.17 rto graph 1.0, 0
# plotting
call 'plot_P.gnu' 'f500_M7_rect'
...
# plotting
call 'plot_P.gnu' 'f1000_M7_rect'

#### plot 3 ####
# labels
set label 1 '$M = 14$, rect.'
set label 2 at graph 1.1, 1.25 '$\sff = 1000$ Hz'
# arrows
unset arrow 1
# positioning
@pos_top
...
# plotting
call 'plot_P.gnu' 'f1000_M14_rect'
...
# plotting
call 'plot_P.gnu' 'f1000_M7_max-rE'
...
# plotting
call 'plot_P.gnu' 'f1000_M14_max-rE'
...
# plotting
call 'plot_k.gnu' 'f1000_M14_rect'
...
# plotting
call 'plot_k.gnu' 'f1000_M7_max-rE
...
# plotting
call 'plot_k.gnu' 'f1000_M14_max-rE
