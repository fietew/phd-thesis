...
LABEL_Y = '$20 \lg |\sfpressure(\sforigin,\sfomega)|$'
# grid
load 'grid.cfg'
# color scheme
...
set label 2 at graph 0.05, 0.6 left front tc ls 2 'high-res.'
set label 3 at graph 0.05, 0.8 left front tc ls 8 'nearest-neighbor'
...
#### plot 1 ####
# labels
set label 4 'discrete SSD'
# positioning
@pos_top_left
set size sx, sy
set origin orix1, oriy1
# plotting
plot 'P_L56_highres0.txt' u ($1/1000):2 w l ls 7 lw 3,\
  'P_L56_highres1.txt' u ($1/1000):2 w l ls 2 lw 2

#### plot 2 ####
# labels
set label 4 'continuous SSD'
# positioning
@pos_bottom_left
set size sx, sy
set origin orix1, oriy2
# plotting
plot 'P_L1024_highres0.txt' u ($1/1000):2 w l ls 7 lw 3,\
  'P_L1024_highres1.txt' u ($1/1000):2 w l ls 2 lw 2
