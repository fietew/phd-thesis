...
\draw[dashed] (0,0) -- (\phimax:\Rdashed);
...
\draw(center) -- (xmax) node[midway,above=-3pt,sloped]{\footnotesize 
$\sfR[subscript=h]$};
\draw(center) -- (xmin);
...
node[below=0.75cm, pos=0,anchor=south]  
