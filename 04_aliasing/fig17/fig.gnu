...
################################################################################
set t epslatex size @disstextwidth,7.6cm color colortext standalone header diss10pt.footnotesize
set output 'fig.tex'
...
sx = 0.33
sy = 0.38
orix1 = 0.035 + 0*0.855*sx
orix2 = 0.035 + 1*0.855*sx
orix3 = 0.035 + 2*0.855*sx
oriy1 = 0.55
oriy2 = 0.095
f = 2000
# functions
db(x) = 20*log10(x)
flabel = 'sprintf(''$\sfNsec = %d$, $\mu \approx %2.1f$'', L, mu)'
