...
################################################################################
set t epslatex size @dissfullwidth,7.6cm color colortext standalone header diss10pt.footnotesize
set output 'fig.tex'
...
# colorbar
set colorbox vert user origin screen 0.82, 0.55 size graph 0.05,1.0
# labels
set label 1 @flabel
# plotting
load 'plotP.gnu'
...
@pos_bottom
# colorbar
set colorbox vert user origin screen 0.87, 0.55 size graph 0.05,1.0
# variables
f = 4000
# labels
set label 1 @flabel
...
# c-axis
set cbrange [1:5]
set cbtics 1 add ('$1$ kHz' 1)
# labels
set label 1 '$\sffS[superscript=WFS](\sfpos)$'
# palette
set palette maxcolors 4
load 'sequential/Blues.plt'  # see gnuplot-colorbrewer
set palette positive
# colorbar
set colorbox vert user origin screen 0.93, 0.55 size graph 0.05,1.0
# plotting
